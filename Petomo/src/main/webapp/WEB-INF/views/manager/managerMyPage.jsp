                                    ...
                                    <ul class="media-list thread-list">
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="img/buyr5.jpg" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="media depth-2 reply-comment">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="img/buyr3.jpg" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <li class="single-thread">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#">
                                                        <img class="media-object" src="img/buyr1.jpg" alt="Commentator Avatar">
                                                    </a>
                                                </div>
                                                <div class="media-body">
                                                    <div class="media-content">
