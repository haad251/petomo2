...
<title>Insert title here</title>
  ...
  <script type="text/javascript" src="<c:url value='/resource/static/video.min.js'/>"></script>
...
<body class="preload">
    ...
    <section class="message_area">
        <div class="container">
         ...
         <source src="http://203.233.196.14:1935/petlive01/myStream/playlist.m3u8" type="application/x-mpegURL">
</video>
