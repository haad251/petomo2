...
public class ReservationAddrVO {
	private String res_id,st_id,service_id,mb_id,res_start,res_end,res_status,
					res_amount,res_review,res_rate,res_memo,md_addr;

	public ReservationAddrVO(String res_id, String st_id, String service_id, String mb_id, String res_start, String res_end,
			 String res_status, String res_amount, String res_review, String res_rate,
			String res_memo, String md_addr) {
		super();
		this.res_id = res_id;
		this.st_id = st_id;
	...
	public String toString() {
		return "ReservationVO [res_id=" + res_id + ", st_id=" + st_id + ", service_id=" + service_id + ", mb_id="
				...
				+ ", res_rate=" + res_rate + ", res_memo=" + res_memo + ", md_addr = " + md_addr + "]";
	}
